from pddlflatland.structs import Predicate, Literal, LiteralConjunction, LiteralDisjunction, ForAll, Exists, Not
from pddlflatland.utils import get_object_combinations
import random
